...
export const GENESIS_ALIASES: Array<{ label: string; specialtySlug: string }> = [
  ...
  { label: 'constipation', specialtySlug: 'gut-health' },
  { label: 'acid reflux', specialtySlug: 'gut-health' },
  { label: 'heartburn', specialtySlug: 'gut-health' },
  { label: 'food sensitivities', specialtySlug: 'gut-health' },
  // Hormone Balance
  ...
  { label: 'low libido', specialtySlug: 'hormone-balance' },
  { label: 'hot flashes', specialtySlug: 'hormone-balance' },
  { label: 'irregular periods', specialtySlug: 'hormone-balance' },
  { label: 'weight gain', specialtySlug: 'hormone-balance' },
  // Stress / Sleep
  ...
  { label: "can't sleep", specialtySlug: 'stress-sleep-optimization' },
  { label: 'overwhelmed', specialtySlug: 'stress-sleep-optimization' },
  { label: 'low energy', specialtySlug: 'stress-sleep-optimization' },
  { label: 'brain fog', specialtySlug: 'stress-sleep-optimization' },
  // Children's
  ...
  // Mind-Body Coaching
  { label: 'depression', specialtySlug: 'mind-body-coaching' },
  { label: 'mood', specialtySlug: 'mind-body-coaching' },
  // Nutrition / Herbal / Functional
  { label: 'nutrition', specialtySlug: 'holistic-nutrition' },
  { label: 'diet', specialtySlug: 'holistic-nutrition' },
  { label: 'meal planning', specialtySlug: 'holistic-nutrition' },
  { label: 'gut diet', specialtySlug: 'holistic-nutrition' },
