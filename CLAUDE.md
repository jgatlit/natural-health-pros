...
| **Vercel project** | `ai-chemist/hhe-directory` — inspector: https://vercel.com/ai-chemist/hhe-directory (**project NOT yet renamed** — DNS cutover is done and the rename is unblocked, but it's being held pending an explicit launch go, batched with the deferred redeploy + auth-gate re-enable) |
